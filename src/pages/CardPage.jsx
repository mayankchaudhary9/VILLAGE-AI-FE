...
export default function CardPage({ type, t, language, setLanguage }) {
  const dataMap = {
    ...
    },
    {
      ...
      image:
        "https://tropogo.com/blogs/images/blog/bg_spraying.png",
      description:
        t.desc_Farming3,
    },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <CardSection t={t} language={language} setLanguage={setLanguage} title={titleMap[type]} data={data} />
    </div>
  );
}