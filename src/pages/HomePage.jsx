      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          ...
          <div className="flex justify-center md:justify-end">
            <img src="https://earth5r.org/wp-content/uploads/2025/07/Farming-with-Intelligence_-Integrating-IoT-AI-and-Climate-Data-into-Organic-Cultivation-ESG-CSR-EARTH5R-NGO-MUMBAI.png"
            alt=""
